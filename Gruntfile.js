...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          "dist/video-upload/plugin.js": [
            "src/text/license-header.js",
            scratchPluginMinPath,
          ],
          "dist/video-upload/plugin.min.js": [
            "src/text/license-header.js",
            scratchPluginMinPath,
          ],
        },
        ...
        files: [
          {
            cwd: "src/text",
            src: ["license.txt"],
            dest: "dist/video-upload",
            expand: true,
          },
          { src: ["changelog.txt"], dest: "dist/video-upload", expand: true },
        ],
      },
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write("dist/video-upload/version.txt", BUILD_VERSION);
  });
